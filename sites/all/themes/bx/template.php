...
function bx_theme() {
  ...
  $items['block'] = array(
    ...
    'template' => 'object',
    'path' => drupal_get_path('theme', 'bx') .'/templates',
  );
  $items['comment'] = array(
 ...
 */
function bx_preprocess_html(&$vars) {
  $vars['classes_array'][] = 'bx';
}

/**
 * Implementation of preprocess_page().
 */
function bx_preprocess_page(&$vars) {
 ...
 */
function bx_preprocess_block(&$vars) {
  $vars['hook'] = 'block';
 ...
 */
function bx_preprocess_node(&$vars) {
  $vars['hook'] = 'node';
 ...
 */
function bx_preprocess_comment(&$vars) {
  $vars['hook'] = 'comment';
 ...
 */
function bx_preprocess_fieldset(&$vars) {
 ...
 */
function bx_preprocess_field(&$vars) {
 ...
 */
function bx_textarea($variables) {
...
function bx_pager($vars) {
  ...
  // ));
  $prev_links['pager-previous'] = theme('pager_previous', array(
  ...
  $next_links['pager-next'] = theme('pager_next', array(
  ...
  $prev_pager_links = theme('links', array(
    'links' => $prev_links,
    'attributes' => array('class' => 'links pager pager-links')
  ));

  $next_pager_links = theme('links', array(
    'links' => $next_links,
    'attributes' => array('class' => 'links pager pager-links')
  ));

  if ($pager_list) {
    return "<div class='pager clearfix'>$prev_pager_links $pager_list $next_pager_links</div>";
  }
}
 ...
 */
function bx_views_mini_pager($vars) {
  $tags = $vars['tags'];
  $quantity = $vars['quantity'];
  $element = $vars['element'];
  $parameters = $vars['parameters'];
